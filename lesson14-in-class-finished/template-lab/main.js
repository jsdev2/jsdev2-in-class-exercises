...
// 1) Add an initialData array, to hold your initial data
...
//    iterates through your initialData and populates the 
//    page with the initial three items, by calling 
//    `addToList`.


// At the beginning you will want to set your model:
// var initialData = ['Dog Bites', 'Bee Stings', 'Feeling Bad'];
...
$(document).ready(function() {
  ...
  // your initialData and run addToList on all the items:

  // initialData.forEach(function(thing) {
